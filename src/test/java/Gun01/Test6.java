...
public class Test6 {
    ...
    By lOkButton2 = By.id("com.touchboarder.android.api.demos:id/buttonDefaultPositive");
    ...
    public void test2(){
        ...
        swipeUntil(xpathOfText("Animation"), .4, .7);// Bu testte before methoddaki implicitly wait çok yavaşlatıyor
    }
